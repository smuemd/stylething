###### [Style Cookbook](index.md)  >  [Typography](themes/index.md)

# Color

_[TODO]_ some intro text about color
...
const A = m(Box, {
  bc: [ 'lightPink', 'pink', 'darkPink' ],
  color: 'black50'
}, 'Equivalent to B')
const B = m(Static, 'Equivalent to A')
```
<!--
