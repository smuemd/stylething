 ...
 * @param b.content {Function}
 * @param b.display {Function}
 * @param b.verticalAlign {Function}
 * @param b.border {Function}
 * @param b.maxWidth {Function}
 * @param theme
 * @return {Object}
 */
export function createBssHelpers (b, theme) {
  ...
  const clearfix = b('*zoom: 1;')
    .$before(b.content(' ').display('table'))
    .$after(b.content(' ').display('table').clear('both'))
